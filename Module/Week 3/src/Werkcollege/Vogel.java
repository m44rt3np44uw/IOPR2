...
public class Vogel extends Dier {
	...
	public void praat() {
		System.out.println("De " + this.dier + " " + this.naam + " heeft " + this.poten + " poten, die elk " + this.lengtePoten + " cm lang zijn, heeft een snavel met de lengte van " + this.snavel + " en heeft " + ((this.staart) ? "wel" : "niet") + " een staart.");
	}
}